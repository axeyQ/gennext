...
export default function LogoScrollSection() {
  const topRowLogos = [
    ...
    { 
      name: 'Anthropic', 
      logo: 'https://cdn.prod.website-files.com/65b8f36fa600366bc7cf9a67/6676e783047401d212c9e8f0_logo_icon.svg',
      color: 'bg-purple-500'
    },
    { 
      name: 'Stability AI', 
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative w-8 h-8 rounded-lg overflow-hidden">
                    ...
                    />
                    <div 
                      className={`w-full h-full ${company.color} rounded-lg items-center justify-center text-white text-xs font-bold hidden`}
                    >
