    ...
    <div ref={containerRef} className="min-h-screen bg-[linear-gradient(180deg,_#040406_50%,_#09080D_100%)] text-white relative flex flex-col justify-between items-center">
      ...
      <section className="relative z-10 px-44 pt-24 pb-32 min-h-11/12 flex items-center justify-start">
        <div className="text-left flex flex-col justify-start h-full align-items-start">
          ...
          <div className="min-h-[140px] mb-8 flex items-start justify-center w-full">
            <TypewriterText 
              texts={typewriterTexts}
              typingSpeed={60}
              deletingSpeed={40}
              pauseDuration={3000}
              className="text-2xl sm:text-3xl max-w-[860px] text-gray-600 text-center typewriter-container"
            />
          </div>
