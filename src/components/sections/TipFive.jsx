...
export default function TipFive() {
      ...
      <div className="relative z-30 ml-96 pl-8 pr-8 h-full flex flex-col justify-center py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
          ...
          >
            ...
            <div>
              <div className="text-8xl font-bold text-purple-400/30 leading-none mb-4">05</div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">
                Chat Window
              </h3>
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
              Ask questions about your solution or files.  Open from the Copilot Badge or CTRL + , C.<br/>
