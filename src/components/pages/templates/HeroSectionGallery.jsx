...
const HeroSectionsGallery = () => {
  ...
  const templates = [
    ...
    },
    {
      ...
      category: 'Light',
      image: 'https://images.unsplash.com/photo-1556075798-4825dfaaf498?w=600&h=800&fit=crop',
      size: 'tall', // 1x2
      featured: false
    },
    {
      ...
      category: 'Minimal',
      image: 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?w=600&h=600&fit=crop',
      size: 'medium', // 1x1
      featured: false
    }
  ];
